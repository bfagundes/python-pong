...
class TestBall(unittest.TestCase):
    ...
    def test_initial_position(self):
        ...
        self.assertEqual(self.ball.xcor(), self.ball.initial_position[0], f"The Ball's Initial position is incorrect on X axis")
        self.assertEqual(self.ball.ycor(), self.ball.initial_position[1], f"The Ball's Initial position is incorrect on Y axis")
    ...
    def test_move(self):
        ...
        self.ball.move()
        self.assertEqual(self.ball.xcor(), initial_x + DIFFICULTY_SETTINGS[DIFFICULTY]["ball_speed"], f"The Ball's movement is incorrect on X axis")
        self.assertEqual(self.ball.ycor(), initial_y + DIFFICULTY_SETTINGS[DIFFICULTY]["start_angle"], f"The Ball's movement is incorrect on Y axis")
    ...
    def test_paddle_collision(self):
        ...
        self.ball.goto(self.left_paddle.paddle.xcor(), self.left_paddle.paddle.ycor())
        ...
        self.ball.goto(self.right_paddle.paddle.xcor(), self.right_paddle.paddle.ycor())
    ...
    def test_speed_increase(self):
        ...
        initial_speed = self.ball.ball_speed
        ...
        self.assertEqual(self.ball.ball_speed, expected_speed, "Speed did not increase correctly after paddle collisions")
    ...
    def test_max_speed(self):
        ...
        self.assertEqual(self.ball.ball_speed, max_speed, "Speed exceeded max speed")
    ...
    def test_adjust_angle(self):
        ...
        for ball_y_offset, expected_result in test_cases:
            with self.subTest(ball_y_offset = ball_y_offset, expected_result = expected_result):
                self.ball.setx(self.left_paddle.paddle.xcor())
                self.ball.sety(self.left_paddle.paddle_bottom + ball_y_offset)
                self.ball.handle_collisions(self.left_paddle, self.right_paddle)
