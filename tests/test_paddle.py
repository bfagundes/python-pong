...
class TestPaddle(unittest.TestCase):
    ...
    def test_move_up(self):
        ...
        self.paddle.move_up()
        self.assertEqual(self.paddle.get_position()[1], initial_y + self.paddle.speed, f"Paddle failed to move up correctly")

    def test_move_down(self):
        """Test the Paddle DOWN movement"""
        initial_y = self.paddle.get_position()[1]
        self.paddle.move_down()
        self.assertEqual(self.paddle.get_position()[1], initial_y - self.paddle.speed, f"Paddle failed to move down correctly")
